...
routes.get("/create", onlyUsers, UserController.registerForm);
routes.get("/", onlyUsers, UserController.list);
routes.get("/:id/edit", onlyUsers, UserValidator.show, UserController.edit);
routes.post("/create", onlyUsers, UserValidator.post, UserController.post);
routes.put("/", onlyUsers, UserValidator.update, UserController.put);
